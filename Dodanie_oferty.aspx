...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView ID="GV_Dodaj_oferta" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id_oferty" DataSourceID="GV_sql_data" Width="941px">
        <Columns>
    ...
    <asp:DetailsView ID="DV_dodaj_oferta" runat="server" AutoGenerateRows="False" DataKeyNames="Id_oferty" DataSourceID="DV_sql_data" Height="50px" OnItemUpdated="DV_dodaj_oferta_ItemUpdated" Width="350px">
        <Fields>
            <asp:BoundField DataField="Id_oferty" HeaderText="Id_oferty" InsertVisible="False" ReadOnly="True" SortExpression="Id_oferty" />
